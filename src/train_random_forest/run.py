...
def go(args):
    ...
    print('=-=' * 50)
    logger.info(X_val.dtypes)

    # Save the sk_pipe pipeline as a mlflow.sklearn model in the directory "random_forest_dir"
    export_path = "random_forest_dir"
    # To handle `Unable to map 'object' type to MLflow DataType.`
    #@TODO should these columns be of type `object`?
    X_val[X_val.select_dtypes(include=['object']).columns] = X_val.select_dtypes(include=['object']).astype(str)
